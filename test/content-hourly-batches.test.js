...
const BATCHES = [
  ...
  { file: 'hourly-batch-007.json', ids: new Set(['randomaccess-offset-io','conditionalweaktable-metadata','array-binarysearch-sorted','file-options-sequentialscan','task-whenall-exceptions','jsondocument-dispose','memory-owner-dispose','stopwatch-getelapsedtime','collections-marshal-setcount','cancellation-token-throwifrequested']) }
];
