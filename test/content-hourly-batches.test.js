...
const BATCHES = [
  ...
  { file: 'hourly-batch-008.json', ids: new Set(['alternate-lookup-span-key','memoryextensions-split-span','readexactly-stream','writeallbytesasync-memory','task-delay-timeprovider','periodic-timer-wait','jsonnode-mutable-dom','regex-enumeratematches-span','linq-countby','linq-aggregateby']) },
  { file: 'hourly-batch-009.json', ids: new Set(['array-clear-range','bitoperations-popcount','enumerable-distinctby','enumerable-maxby','file-readlines-streaming','json-polymorphism-attributes','memory-stream-getbuffer','string-contains-comparison','task-whenany-timeout','weakreference-cache']) },
  { file: 'hourly-batch-010.json', ids: new Set(['convert-tohexstring','rune-unicode-scalar','iparsable-generic-parsing','http-completion-responseheadersread','json-deserialize-async-enumerable','regex-match-timeout','operating-system-platform-check','ziparchive-create-entry','file-move-overwrite','enumerable-minby']) },
  { file: 'hourly-batch-011.json', ids: new Set(['binaryprimitives-endian','utf8parser-span','memorymappedfile-view','file-enumerate-lines-async','json-extension-data','httpclient-default-request-version','task-yield-ui-loop','readonlysequence-segments','arraypool-clear-return','exception-inner-chain']) }
];
